...
export class CorrectiveComponent {
  //chip
  visible = true;
  selectable = true;
  removable = true;
  ...
  initCalendar() {
    this.calendar = new Calendar(document.getElementById("calendar4"), {
  ...
  ngAfterViewInit():void {
    ...
    this.browserOnly(() => {
      ...
      let chart = am4core.create("chartdiv12", am4plugins_timeline.SerpentineChart);
